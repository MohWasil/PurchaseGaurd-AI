...
# Stateful agent for end-to-end receipt processing
# """
...
#     deadlines: Dict[str, Optional[datetime]]
...
#     """Node 2: Extract structured data using LLM"""
...
#         return state
#     except Exception as e:
#         state["errors"].append(f"Data extraction failed: {str(e)}")
#         return state
...
#         return state
#     except Exception as e:
#         state["errors"].append(f"Deadline calculation failed: {str(e)}")
#         state["deadlines"] = {
#             "purchase_date": datetime.utcnow(),
...
#         alerts.append({
#             "type": "high_value",
#             "message": f"High value purchase: ${amount:.2f} - keep receipt safe!",
#             "priority": "high"
#         })
